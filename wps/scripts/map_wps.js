...
var URL;
    function addWPSServer(){
        ...
        URL = document.getElementById("addServerURL").value  ;
        getCapabilities();
...
// dynamically create a form from the process description
    function buildForm() {
        ...
        document.getElementById("input").innerHTML = "<h4>Input:</h4>";
