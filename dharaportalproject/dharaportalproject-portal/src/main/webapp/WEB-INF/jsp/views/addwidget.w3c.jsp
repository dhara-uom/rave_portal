	        ...
	        <fieldset>
	            ...
	            <div id="addWidgetForm">
	                ...
	                <div class="control-group">
	                    ...
	                    <label class="control-label-3" for="url"><fmt:message key="widget.url"/> *</label>
	                ...
	                <div class="control-group">
	                    <form:label cssClass="control-label-3" path="title"> <fmt:message key="widget.title"/> *</form:label>
	                    <div class="controls">
	                ...
	                <div class="control-group">
	                    <form:label cssClass="control-label-3" path="description"><fmt:message key="widget.description"/> *</form:label>
	                ...
	                <div class="control-group">
	                    <spring:bind path="thumbnailUrl">
	                        <label class="control-label-3" for="thumbnailUrl"><fmt:message key="widget.thumbnailUrl"/></label>
	                ...
	                <div class="control-group">
	                    <spring:bind path="screenshotUrl">
	                        <label class="control-label-3" for="screenshotUrl"><fmt:message key="widget.screenshotUrl"/></label>
	                        <div class="controls">
	                ...
	                <div class="control-group">
	                    <spring:bind path="titleUrl">
	                        <label class="control-label-3" for="titleUrl"><fmt:message key="widget.titleUrl"/></label>
	                ...
	                <div class="control-group">
	                    <form:label cssClass="control-label-3" path="author"><fmt:message key="widget.author"/></form:label>
	                ...
	                <div class="control-group">
	                    <spring:bind path="authorEmail">
	                        <label class="control-label-3" for="authorEmail"><fmt:message key="widget.authorEmail"/></label>
