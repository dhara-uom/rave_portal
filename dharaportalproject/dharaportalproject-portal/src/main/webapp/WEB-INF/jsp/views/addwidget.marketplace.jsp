                ...
                <fieldset>
                    ...
                    <c:if test="${not empty tags}">
                        <div class="control-group">
                            <label class="control-label-3" for="categoryList"><fmt:message key="page.store.list.widgets.tag"/></label>
                            <div class="controls">
                    ...
                    <c:if test="${not empty categories}">
                        <div class="control-group">
                            <label class="control-label-3" for="marketplaceCategoryList"><fmt:message key="page.store.list.widgets.category"/></label>
                            <div class="controls">
