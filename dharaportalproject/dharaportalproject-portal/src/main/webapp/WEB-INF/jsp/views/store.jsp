...
<section class="span4">
    <div class="storeItem">
        <div class="widget-title-bar">XBaya GUI
        </div>
        <div class="storeItemLeft">
            <button class="btn btn-primary">
                <a style="color: #F8F8F8" href="http://www.extreme.indiana.edu/xbaya/#download">Download</a></button>
        </div>
        <div class="storeItemCenter">
            <h4><a class="secondaryPageItemTitle" href="http://www.extreme.indiana.edu/xbaya/">XBaya GUI</a></h4>

            <div class="storeWidgetDesc">XBaya is a graphical client program for workflow composition, monitoring,
                and more. It provides an easy-to-use GUI for users to compose workflows from Web Services described in
                WSDL.
                <br><br>
                Download XBaya GUI to create workflows using Apache Airavata
            </div>
        </div>
    </div>
</section>
