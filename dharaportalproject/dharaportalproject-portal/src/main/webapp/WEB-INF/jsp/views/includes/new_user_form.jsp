...
<form:form cssClass="form-horizontal" id="newAccountForm" commandName="newUser" action="newaccount" method="POST">
    <fieldset>
        <p style="color: #ec0000"><fmt:message key="form.all.fields.required"/></p>

        <p><form:errors cssClass="error"/></p>


        <div class="control-group">
            <label class="control-label-3" for="userNameField"><fmt:message key="page.general.username"/></label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label-3" for="passwordField"><fmt:message key="page.general.password"/></label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label-3" for="passwordConfirmField"><fmt:message key="page.general.confirmpassword"/></label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label-3" for="emailField"><fmt:message key="page.general.email"/></label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label-3" for="openIdField"><fmt:message key="page.general.openid"/></label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label-3" for="pageLayoutField"><fmt:message key="page.general.addpage.selectlayout"/></label>
            <div class="controls">
    ...
    <h2 style="color: #383636"><fmt:message key="page.general.personal.information"/></h2>

    <fieldset>
        <div class="control-group">
            <label class="control-label-3" for="firstNameField"><fmt:message key="page.general.first.name"/></label>
            <div class="controls"><form:input id="firstNameField" path="givenName"/></div>
        </div>
        <div class="control-group">
            <label class="control-label-3" for="lastNameField"><fmt:message key="page.general.last.name"/></label>
            <div class="controls"><form:input id="lastNameField" path="familyName"/></div>
        </div>
        <div class="control-group">
            <label class="control-label-3" for="displayNameField"><fmt:message key="page.general.display.name"/></label>
            <div class="controls"><form:input id="displayNameField" path="displayName"/></div>
        </div>
        <div class="control-group">
            <label class="control-label-3" for="statusField"><fmt:message key="page.general.relation.status"/></label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label-3" for="aboutMeField"><fmt:message key="page.general.about.me"/></label>
